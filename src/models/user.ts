...
export class User {
    ...
    async createNewPassword(pass: string) {
        if (!UserUtils.isPasswordValid(pass)) {
            throw new Error('A senha precisa ter pelo menos 1 letra maiúscula, 1 letra minúscula, 1 número e 1 caractere especial. No mínimo 8 caracteres e no máximo 20.');
        }
